...
--
-- Table structure for table `access_track`
--

DROP TABLE IF EXISTS `access_track`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `access_track` (
...
CREATE TABLE `rent` (
  ...
  `id_car` varchar(15) DEFAULT NULL,
...
-- Dump completed on 2025-05-03 18:21:21
